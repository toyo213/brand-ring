(function($) {
	$(document).ready( function() {
		if ( cntctfrmpr_ajax.cntctfrmpr_delete_multi_link ) {
		...
		var arr = [ 'department', 'name', 'address', 'email', 'phone', 'subject', 'message', 'attachment', 'captcha' ];
		...
		$( '.cntctfrmpr_language_tab_block_mini' ).live( 'click touchstart', function() {
		...
		$( '.cntctfrmpr_department_delete label' ).live( 'click', function() {
