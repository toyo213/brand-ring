<?php
if(isset($_POST['spa_banner_settings']))
{	if($_POST['spa_banner_settings'] == 1)
	{	if(!empty($_POST))
	...
	if($_POST['spa_banner_settings'] == 2) 
	{	$current_options=get_option('spa_theme_options');	
		
		$current_options['banner_title_one_category']= __('GET YOURSELF','sis_spa');
		$current_options['banner_title_two_category']=__('REFRESHED','sis_spa');
		$current_options['banner_description_category']= __(' Banner Description Donec justo odio, lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla. Curabitur sed lectus nulla.lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla rutrum sit amet mauris','sis_spa');
		
		$current_options['banner_title_one_author']= __('GET YOURSELF','sis_spa');
		$current_options['banner_title_two_author']=__('REFRESHED','sis_spa');
		$current_options['banner_description_author']= __(' Banner Description Donec justo odio, lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla. Curabitur sed lectus nulla.lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla rutrum sit amet mauris','sis_spa');
		
		$current_options['banner_title_one_404']= __('GET YOURSELF','sis_spa');
		$current_options['banner_title_two_404']=__('REFRESHED','sis_spa');
		$current_options['banner_description_404']= __(' Banner Description Donec justo odio, lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla. Curabitur sed lectus nulla.lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla rutrum sit amet mauris','sis_spa');
		
		$current_options['banner_title_one_tag']= __('GET YOURSELF','sis_spa');
		$current_options['banner_title_two_tag']=__('REFRESHED','sis_spa');
		$current_options['banner_description_tag']= __(' Banner Description Donec justo odio, lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla. Curabitur sed lectus nulla.lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla rutrum sit amet mauris','sis_spa');
		
		$current_options['banner_title_one_search']= __('GET YOURSELF','sis_spa');
		$current_options['banner_title_two_search']=__('REFRESHED','sis_spa');
		$current_options['banner_description_search']= __(' Banner Description Donec justo odio, lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla. Curabitur sed lectus nulla.lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla rutrum sit amet mauris','sis_spa');
		
		
		update_option('spa_theme_options' , $current_options);
	}	
} ?>
<div class="block ui-tabs-panel ui-widget-content ui-corner-bottom" id="option_banner_header" aria-labelledby="ui-id-9" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
	<input type="hidden" value="Header" name="header">
	<form method="post" action = "" style="width:751px;" id="spa_option_banner_header">		
		 <?php wp_nonce_field('spa_customization_nonce_banner','spa_banner_nonce_customization'); ?> <!--nonce check form-->
 ...
 <h3><b><?php _e('Banner Configuration For 404 Template'); ?></b></h3>
  ...
  <div>
    ...
    <textarea class="inputwidth" style="height:100px;" name="banner_description_search" id="banner_description_search" > <?php if($current_options['banner_description_search']!='') { echo esc_attr($current_options['banner_description_search']); } ?></textarea>
		...
		<input type="hidden" value="1" id="spa_banner_settings" name="spa_banner_settings" /> 
		<input type="button" class="button-framework save-options"  value= "<?php _e('Save Changes', 'sis_spa');?>" onclick="datasave_banner()">
		<input type="button" class="button-framework reset" value="<?php _e('Restore Defaults','sis_spa');?>" onclick="reset_data_banner()" />
		<div id="success_message_reset_banner"  class="success_message" ><img style="padding-right:5px;" src="<?php echo  get_template_directory_uri();?>/option_pannel/images/icon_check.png" /><?php _e('Data reset sucessfully','sis_spa'); ?></div>
		<div id="success_message_save_banner" class="success_message" ><img style="padding-right:5px;" src="<?php echo  get_template_directory_uri();?>/option_pannel/images/icon_check.png" /><?php _e('Data save sucessfully','sis_spa'); ?></div>	
	</form>
</div>