					...
					<div class="media" id="blog-media">
						<div class="blog-icon-media"> 
							...
							<ul class="spa-blog-icon clearfix" id="blog-left-icons">
								...
								<li class="comment-icon">  <?php  comments_popup_link( __( 'Leave a comment', 'sis_spa' ),	__( '1 Comment', 'sis_spa' ), __( '% Comments', 'sis_spa' ) ); ?></li>
							</ul>
						</div>
						...
						<a href="<?php the_permalink(); ?>"title="<?php the_title(); ?>" class="blog-heading"><?php the_title(); ?></a>
							...
							<div class="blog_content"><p><?php echo get_the_other_excerpt();?></p><br/></div>
