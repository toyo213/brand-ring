...
add_filter( 'intermediate_image_sizes', 'spa_service_image_size_filter');
function spa_service_image_size_filter($sizes)
{
...
add_filter( 'intermediate_image_sizes', 'spa_slider_image_size_filter');
function spa_slider_image_size_filter($sizes){
    $type = get_post_type($_REQUEST['post_id']);
	foreach($sizes as $key => $value){
...
//code for products 
add_filter( 'intermediate_image_sizes','spa_products_image_size_filter'); 
function spa_products_image_size_filter($sizes){
    $type = get_post_type($_REQUEST['post_id']);
	foreach($sizes as $key => $value){
...
add_filter( 'intermediate_image_sizes', 'spa_post_image_size_filter');
function spa_post_image_size_filter($sizes){
    $type = get_post_type($_REQUEST['post_id']);
	foreach($sizes as $key => $value){
...
add_filter( 'intermediate_image_sizes', 'spa_team_image_size_filter');
function spa_team_image_size_filter($sizes){
    $type = get_post_type($_REQUEST['post_id']);
	foreach($sizes as $key => $value){
...
add_filter( 'intermediate_image_sizes', 'spa_singlepage_image_size_filter');
function spa_singlepage_image_size_filter($sizes)
{
    $type = get_post_type($_REQUEST['post_id']);
	foreach($sizes as $key => $value){
