	...
	<table class="table table-bordered table-condensed">
     ...
     <tr>
	    <td class="lable-all">Style</td>
    			<td >
					<select class="select-medium" size="1" id="headingstyle" name="headingstyle">
	 ...
	 <tr>
        ...
        <td><input class="input-medium" type="text" name="heading-title" value="" id="heading-title" /></td>
    </tr>
    <td>&nbsp;</td>
<td><a href="javascript:HRDialog.insert(HRDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Insert</a></td>
</tbody>
</table>
</form>