				...
				<div class="row-fluid">
				    ...
				    <?php the_post();?>
						...
						<?php 	$spa_detailed_content=get_the_content();
								$spaservices_filtered_content=preg_replace('/<img[^>]+./','',$spa_detailed_content); ?>
						<?php   $image_query = new WP_Query( array( 'post_type' => 'attachment','post_status' => 'inherit', 'post_mime_type' => 'image',  'post_parent' => get_the_ID() ) );								
						if($image_query->have_posts()):?>  
					<div class="pikachoose">
					<ul id="pikame" >
						<?php 	while( $image_query->have_posts() ) {
					...
					<?php endif;
					wp_reset_query(); ?>
					<div class="service-detail-content"><p><?php echo $spaservices_filtered_content;?></p></div>
